...
var trial1=document.getElementById('trial1');
...
slide11.classList.remove('slide1');
slide11.classList.remove('slide2');
slide11.classList.remove('slide3');
slide11.classList.remove('slide4');
slide11.classList.remove('slide5');
slide11.classList.add('slide1');
